...
public class MultiplayerDeathLayer extends Layer {
	...
	public MultiplayerDeathLayer(String name, Game game) {
		super(name);
		this.game = game;
	}
	...
	@Override
	public void update() {
		if (Keyboard.instance.isKeyDown(KeyEvent.VK_ESCAPE))
			game.setToMainMenuFlag(true);
		else if (Keyboard.instance.isKeyDown(KeyEvent.VK_SPACE))
	...
	public void render(Graphics2D g) {
		...
		g.setFont(secondary);
		g.drawString("Press space to return to the game or escape to return to the main menu", 50, 115);
	}
